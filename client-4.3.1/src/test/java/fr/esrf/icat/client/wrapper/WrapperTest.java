...
public class WrapperTest {
	...
	public void testWrapper() throws Exception {
		Instrument inst = (Instrument) client.get("Instrument", 393);
		WrappedEntityBean w = new WrappedEntityBean(inst);
		...
		assertEquals("Wrong invetigation instrument", inst.getInvestigationInstruments(), w.get("investigationInstruments"));
